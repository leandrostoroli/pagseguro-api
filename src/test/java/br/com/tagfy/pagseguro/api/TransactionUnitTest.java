...
public class TransactionUnitTest {
	...
	private TransactionDetailRequest mockTransactionDetailRequest;
	...
	public void setup() throws Exception {
		...
		mockTransactionDetailRequest = Mockito.mock(TransactionDetailRequest.class);
		Mockito.when(mockTransactionDetailRequest.getRequest()).thenReturn(mockRequestBuilder);
	}
	
	@Test
	public void shouldGetTransaction() {
		try {
			Transaction transaction = TransactionService.detail(mockTransactionDetailRequest);
...
//			assertEquals(DateParserUTC.parse("2011-02-10T16:13:41.000-03:00"), transaction.getDate());
	...
	public void shouldGetErrorCode() {
		...
		Exception exc = null;
		try {
			TransactionService.detail(mockTransactionDetailRequest);
		} catch (Exception e) {
			e.printStackTrace();
			exc = e;
		}
